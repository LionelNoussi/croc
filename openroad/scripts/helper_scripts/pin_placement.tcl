...
set chipW            [expr 2235 - 2 * (39)];    # 2235 with sealring spacing
set chipH            [expr 2235 - 2 * (39)];    # 2235 with sealring spacing
...
set startTop [expr $chipW - $padD - $offset - $padW - $bondpadW]
